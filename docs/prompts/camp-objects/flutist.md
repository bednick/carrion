...
Управляет громкостью категории «музыка» (по клику — всплывающий ползунок); та же величина
доступна в меню настроек звука в правом верхнем углу.
...
| Параметр          | Значение                                                      |
|-------------------|--------------------------------------------------------------|
| Позиция в лагере  | x≈955, y≈648 (правее сундука, левее информатора)                |
